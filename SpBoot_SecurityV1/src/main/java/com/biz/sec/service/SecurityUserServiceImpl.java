...
public class SecurityUserServiceImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		// .get() method를 실행해준다.
		Collection<GrantedAuthority> authorities = this.getUserAuthorities(userVO.get().getUserRoles());
	 ...
	 */
	private Collection<GrantedAuthority> getUserAuthorities(Set<UserRole> userRoles) {
